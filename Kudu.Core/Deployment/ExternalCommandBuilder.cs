...
namespace Kudu.Core.Deployment
{
    public abstract class ExternalCommandBuilder : ISiteBuilder
    {
        ...
        public ExternalCommandBuilder(IEnvironment environment, string repositoryPath, IBuildPropertyProvider propertyProvider)
        {
        ...
        protected void RunCommand(DeploymentContext context, string command)
        {
            ...
            exe.EnvironmentVariables[ManifestPath] = context.ManifestPath;
